...
const NewsLetter = () => {
    return (
        <>
            ...
            <div className=" max-w-screen-2xl space-y-8 m-auto py-4 lg:py-5 px-4 lg:px-20 rounded-lg bg-orange-500">
                <form>
                  <div className="flex flex-col items-center gap-5 py-20">

                    <h6 className=" font-sans text-white text-4xl text-center font-bold">Subscribe to our Newsletter for upcoming </h6>
                    <h6 className="font-sans  text-white text-4xl text-center font-bold">trip Updates</h6>
