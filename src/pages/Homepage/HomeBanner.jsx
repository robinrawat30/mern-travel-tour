                    ...
                    <div className="hero  min-h-screen">
                        <div className="hero-content  flex-col-reverse  md:flex-row-reverse  lg:justify-start items-center">
                            <div className="  rounded-xl relative">
                                <img src={Hero} className=" rounded-lg  bg-blue-500 -z-10  md:max-w-sm  shadow-2xl" />
                            ...
                            <div className=" space-y-10 md:space-y-20">
                                <h1 className=" font-bold font-sans text-6xl">Safar with us & <br></br> explore hidden gems <br /><span className=" text-yellow-400"><span className=" text-xl  text-black">...</span>{" "}{typeEffect}</span></h1>
                                ...
                                <p className="text-sm   text-white"><VerifiedIcon fontSize="small"  />Traval with experts{" "}<VerifiedIcon fontSize="small" />Explore hidden gems{"  "}<VerifiedIcon fontSize="small" />Instant booking</p>
                                <div>
                                    <Link to='/packages' className=" btn bg-blue-500 text-white ">Get Started</Link>
                                </div>
